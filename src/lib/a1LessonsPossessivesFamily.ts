...
export const a1LessonsPossessivesFamily: Lesson[] = [
  // ==================== ПРИТЯЖАТЕЛЬНЫЕ МЕСТОИМЕНИЯ И СЕМЬЯ (15 УРОКОВ) ====================
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Притяжательные местоимения показывают принадлежность. Mi = мой/моя, Tu = твой/твоя, Su = его/её/Ваш.",
      },
      newWords: [],
      grammar: {
      ...
      listening: {
        ...
        transcript:
          "Esta es mi familia. Este es mi padre y esta es mi madre. Estos son mis hermanos. ¿Y tu familia? Tu hermana es muy simpática. Su casa es grande. Sus hijos son estudiantes.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-46.mp3",
    readingText:
      'Los posesivos son palabras muy importantes. MI y MIS significan "мой/моя/мои". TU y TUS significan "твой/твоя/твои". SU y SUS significan "его/её/Ваш/ваши". Estos posesivos cambian solo en número: mi casa → mis casas, tu libro → tus libros. No cambian por género: mi padre, mi madre (ambos usan "mi").',
    duration: 29,
    order: 46,
    isFree: false,
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "NUESTRO и VUESTRO изменяются по роду и числу, в отличие от mi/tu/su.",
      },
      newWords: [],
      grammar: {
      ...
      listening: {
        ...
        transcript:
          "Nuestra familia es grande. Nuestro padre trabaja en Madrid. Nuestra madre es profesora. Nuestros hermanos estudian en la universidad. ¿Y vuestra familia? ¿Vuestro padre trabaja?",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-47.mp3",
    readingText:
      "NUESTRO y VUESTRO son diferentes de MI y TU porque cambian según el género y el número. Nuestro libro (м.р., ед.ч.), nuestra mesa (ж.р., ед.ч.), nuestros libros (м.р., мн.ч.), nuestras mesas (ж.р., мн.ч.). Lo mismo con VUESTRO: vuestro coche, vuestra casa, vuestros amigos, vuestras amigas.",
    duration: 30,
    order: 47,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Padre = отец, Madre = мать, Padres = родители. Важные слова для описания семьи.",
      },
      newWords: [],
      grammar: {
        ...
        examples: [
          ...
          {
            spanish: "Mis padres viven en España",
            russian: "мои родители живут в Испании",
          },
          { spanish: "Tu padre es médico", russian: "твой отец врач" },
          { spanish: "Su madre es profesora", russian: "её мать учительница" },
          {
            spanish: "Nuestros padres son jubilados",
            russian: "наши родители на пенсии",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Mi padre se llama Juan. Mi madre se llama María. Mis padres tienen 60 años. Mi padre es ingeniero y mi madre es enfermera. Viven en Sevilla. ¿Cómo se llaman tus padres?",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-48.mp3",
    readingText:
      "La familia es muy importante en la cultura hispana. El PADRE es el papá. La MADRE es la mamá. Juntos son LOS PADRES. Podemos usar formas cariñosas: papá, mamá, papi, mami. También: mi viejo, mi vieja (coloquial). Es común vivir cerca de los padres y visitarlos frecuentemente.",
    duration: 27,
    order: 48,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Hermano = брат, Hermana = сестра, Hermanos = братья/сестры (смешанная группа)",
      },
      newWords: [],
      grammar: {
        title: "Vocabulario: Hermanos",
        explanation:
          "Hermano (брат), Hermana (сестра), Hermanos (братья и сестры)",
        examples: [
          {
            spanish: "Mi hermano se llama Pedro",
            russian: "моего брата зовут Педро",
          },
          {
            spanish: "Mi hermana tiene 20 años",
            russian: "моей сестре 20 лет",
          },
          {
            spanish: "Tengo dos hermanos",
            russian: "у меня два брата/двое братьев и сестер",
          },
          { spanish: "Mi hermano mayor", russian: "мой старший брат" },
          { spanish: "Mi hermana menor", russian: "моя младшая сестра" },
          {
            spanish: "Somos tres hermanos",
            russian: "нас трое братьев/сестер",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Tengo un hermano y una hermana. Mi hermano mayor se llama Carlos y tiene 30 años. Mi hermana menor se llama Ana y tiene 18 años. Yo soy el del medio. Mis hermanos viven conmigo.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-49.mp3",
    readingText:
      "Los HERMANOS son muy importantes en la familia. Un HERMANO es un chico. Una HERMANA es una chica. HERMANOS puede significar solo hermanos varones, o hermanos y hermanas juntos. El hermano MAYOR es el más viejo. El hermano MENOR es el más joven. Si eres el único: hijo único (м) o hija única (ж).",
    duration: 28,
    order: 49,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      ...
      grammar: {
        ...
        examples: [
          ...
          {
            spanish: "Mi hija va a la escuela",
            russian: "моя дочь ходит в школу",
          },
          { spanish: "Tengo tres hijos", russian: "у меня трое детей" },
          { spanish: "Sus hijos son gemelos", russian: "его дети близнецы" },
          {
            spanish: "Nuestros hijos estudian mucho",
            russian: "наши дети много учатся",
          },
          {
            spanish: "¿Cuántos hijos tienes?",
            russian: "сколько у тебя детей?",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Mi hermana tiene dos hijos. Su hijo se llama Tomás y tiene 8 años. Su hija se llama Laura y tiene 6 años. Mis hijos son mis sobrinos. Son muy inteligentes y estudian en una buena escuela.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-50.mp3",
    readingText:
      "HIJO e HIJA son palabras esenciales. Un HIJO es un niño varón en relación con sus padres. Una HIJA es una niña. HIJOS puede significar solo hijos varones, o hijos e hijas juntos. Pregunta común: ¿Tienes hijos? ¿Cuántos hijos tienes? Los hijos pueden ser pequeños (niños) o adultos - siempre son hijos de sus padres.",
    duration: 27,
    order: 50,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Abuelo = дедушка, Abuela = бабушка, Abuelos = бабушка и дедушка",
      },
      newWords: [],
      grammar: {
        title: "Vocabulario: Abuelos",
        explanation:
          "Abuelo (дедушка), Abuela (бабушка), Abuelos (дедушка и бабушка)",
        examples: [
          {
            spanish: "Mi abuelo tiene 80 años",
            russian: "моему дедушке 80 лет",
          },
          {
            spanish: "Mi abuela cocina muy bien",
            russian: "моя бабушка очень хорошо готовит",
          },
          {
            spanish: "Mis abuelos viven en el campo",
            russian: "мои бабушка и дедушка живут в деревне",
          },
          {
            spanish: "Visito a mis abuelos cada domingo",
            russian: "я навещаю бабушку и дедушку каждое воскресенье",
          },
      ...
      listening: {
        ...
        transcript:
          "Mis abuelos son maravillosos. Mi abuelo se llama Antonio y tiene 78 años. Mi abuela se llama Carmen y tiene 75 años. Viven en un pueblo pequeño. Cada verano voy a visitarlos. Mi abuela hace las mejores comidas.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-51.mp3",
    readingText:
      "Los ABUELOS son muy queridos en la cultura hispana. El ABUELO es el padre de tu padre o madre. La ABUELA es la madre de tu padre o madre. Formas cariñosas: abuelito, abuelita, yayo, yaya. Los abuelos a menudo cuidan a los nietos y transmiten tradiciones familiares. Es común que varias generaciones vivan cerca.",
    duration: 29,
    order: 51,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      ...
      grammar: {
        ...
        examples: [
          ...
          {
            spanish: "Mi nieta es muy inteligente",
            russian: "моя внучка очень умная",
          },
          { spanish: "Tengo cuatro nietos", russian: "у меня четверо внуков" },
          {
            spanish: "Los nietos visitan a los abuelos",
            russian: "внуки навещают бабушку и дедушку",
          },
          { spanish: "Es el nieto favorito", russian: "это любимый внук" },
          {
            spanish: "Mis nietos me hacen feliz",
            russian: "мои внуки делают меня счастливым",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Mi abuela habla de sus nietos con mucho amor. Tiene seis nietos en total. Su nieto mayor tiene 15 años y su nieta menor tiene 2 años. Todos los nietos viven cerca y la visitan frecuentemente.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-52.mp3",
    readingText:
      "Los NIETOS son los hijos de tus hijos. Un NIETO es el hijo varón de tu hijo o hija. Una NIETA es la hija de tu hijo o hija. Para los abuelos, los nietos son muy especiales. En España y Latinoamérica, es común que los abuelos pasen mucho tiempo con sus nietos, los cuiden y les enseñen cosas.",
    duration: 26,
    order: 52,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      ...
      grammar: {
        ...
        examples: [
          {
            spanish: "Mi tío vive en México",
            russian: "мой дядя живет в Мексике",
          },
          { spanish: "Mi tía es médica", russian: "моя тетя врач" },
          {
            spanish: "Mis tíos tienen tres hijos",
            russian: "у моих дяди и тети трое детей",
          },
          { spanish: "El tío Juan", russian: "дядя Хуан" },
          {
            spanish: "La tía María es muy simpática",
            russian: "тетя Мария очень приятная",
          },
          {
            spanish: "Visito a mis tíos en verano",
            russian: "я навещаю дядю и тетю летом",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Tengo muchos tíos. Mi tío Pedro es el hermano de mi padre. Mi tía Rosa es la hermana de mi madre. Mis tíos viven en diferentes ciudades. Este fin de semana vamos a casa de mi tío Carlos para una reunión familiar.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-53.mp3",
    readingText:
      'Los TÍOS son hermanos o hermanas de tus padres. El TÍO puede ser el hermano de tu padre o de tu madre. La TÍA puede ser la hermana de tu padre o de tu madre. También llamamos TÍO/TÍA a los esposos de estos hermanos. En español, "tío/tía" también se usa coloquialmente para decir "amigo/amiga" (¡Hola, tío!).',
    duration: 28,
    order: 53,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Sobrino = племянник, Sobrina = племянница, Sobrinos = племянники",
      },
      newWords: [],
      grammar: {
        ...
        examples: [
          {
            spanish: "Mi sobrino tiene 10 años",
            russian: "моему племяннику 10 лет",
          },
          {
            spanish: "Mi sobrina estudia medicina",
            russian: "моя племянница изучает медицину",
          },
          {
            spanish: "Tengo seis sobrinos",
            russian: "у меня шестеро племянников",
          },
          {
            spanish: "Mis sobrinos son muy traviesos",
            russian: "мои племянники очень озорные",
          },
          { spanish: "El sobrino favorito", russian: "любимый племянник" },
          {
            spanish: "Llevo a mis sobrinos al parque",
            russian: "я вожу племянников в парк",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Soy tío de cinco sobrinos. Mi sobrino mayor se llama Diego y tiene 12 años. Mi sobrina menor se llama Sofía y tiene 4 años. Me encanta pasar tiempo con mis sobrinos. Este sábado vamos al zoológico juntos.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-54.mp3",
    readingText:
      "Los SOBRINOS son los hijos de tus hermanos o hermanas. Un SOBRINO es el hijo varón de tu hermano o hermana. Una SOBRINA es la hija de tu hermano o hermana. Si tienes sobrinos, tú eres su TÍO (si eres hombre) o su TÍA (si eres mujer). Los tíos a menudo tienen una relación especial con sus sobrinos.",
    duration: 27,
    order: 54,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Primo = двоюродный брат/кузен, Prima = двоюродная сестра/кузина",
      },
      newWords: [],
      grammar: {
        title: "Vocabulario: Primos",
        explanation:
          "Primo (двоюродный брат), Prima (двоюродная сестра), Primos (кузены)",
        examples: [
          {
            spanish: "Mi primo vive en Argentina",
            russian: "мой двоюродный брат живет в Аргентине",
          },
          {
            spanish: "Mi prima es ingeniera",
            russian: "моя двоюродная сестра инженер",
          },
          { spanish: "Tengo muchos primos", russian: "у меня много кузенов" },
          {
            spanish: "Mis primos y yo jugamos juntos",
            russian: "мы с кузенами играем вместе",
          },
      ...
      listening: {
        ...
        transcript:
          "Tengo muchos primos porque mi padre tiene cuatro hermanos. Mi primo favorito se llama Javier. Él y yo tenemos la misma edad. Cada Navidad toda la familia se reúne y vemos a todos nuestros primos. Son más de veinte primos en total.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-55.mp3",
    readingText:
      "Los PRIMOS son los hijos de tus tíos. Un PRIMO es el hijo varón de tu tío o tía. Una PRIMA es la hija de tu tío o tía. En familias grandes, puedes tener muchos primos. Los primos hermanos comparten abuelos. Los primos segundos comparten bisabuelos. Los primos a menudo son amigos cercanos en la infancia.",
    duration: 29,
    order: 55,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Esposo/Marido = муж, Esposa/Mujer = жена. Разные слова, одно значение.",
      },
      newWords: [],
      grammar: {
        ...
        examples: [
          ...
          {
            spanish: "Su esposa trabaja en un banco",
            russian: "его жена работает в банке",
          },
          {
            spanish: "Mi marido cocina muy bien",
            russian: "мой муж очень хорошо готовит",
          },
          { spanish: "Mi mujer es profesora", russian: "моя жена учительница" },
          {
            spanish: "Los esposos celebran su aniversario",
            russian: "супруги празднуют годовщину",
          },
      ...
      listening: {
        ...
        transcript:
          "Mi hermana está casada. Su esposo se llama Roberto. Ellos se casaron hace cinco años. Roberto es ingeniero y mi hermana es abogada. Son una pareja muy feliz. Viven en una casa cerca de la playa.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-56.mp3",
    readingText:
      'Para hablar del cónyuge, tenemos varias palabras. ESPOSO y MARIDO significan lo mismo (муж). ESPOSA y MUJER también (жена). ESPOSO/ESPOSA son más formales. MARIDO/MUJER son más comunes en el habla cotidiana. También: mi pareja (моя пара), mi media naranja (моя половинка - literalmente "mi media naranja").',
    duration: 28,
    order: 56,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      ...
      grammar: {
        ...
        explanation:
          "Suegro (свекор/тесть), Suegra (свекровь/теща), Yerno (зять), Nuera (невестка)",
        examples: [
          {
            spanish: "Mi suegro es muy amable",
            russian: "мой тесть очень любезный",
          },
          {
            spanish: "Mi suegra cocina delicioso",
            russian: "моя свекровь вкусно готовит",
          },
          {
            spanish: "Mis suegros viven en Valencia",
            russian: "мои свекры живут в Валенсии",
          },
          { spanish: "Mi yerno es arquitecto", russian: "мой зять архитектор" },
          {
            spanish: "Mi nuera es muy educada",
            russian: "моя невестка очень воспитанная",
          },
          {
            spanish: "Ceno con mis suegros los domingos",
            russian: "я ужинаю со свекрами по воскресеньям",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Tengo una buena relación con mis suegros. Mi suegro es jubilado y mi suegra es profesora. Viven cerca de nosotros. Mis padres también adoran a mi esposa, su nuera. Mi hermano está casado y su esposa es nuestra nueva cuñada.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-57.mp3",
    readingText:
      "La familia política es la familia de tu esposo/esposa. SUEGRO es el padre de tu cónyuge. SUEGRA es la madre de tu cónyuge. Si eres hombre y te casas, eres el YERNO de tus suegros. Si eres mujer y te casas, eres la NUERA de tus suegros. Estas relaciones son importantes en la cultura hispana.",
    duration: 30,
    order: 57,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Cuñado = брат/сестра супруга (мужского рода), Cuñada = брат/сестра супруга (женского рода)",
      },
      newWords: [],
      grammar: {
        title: "Vocabulario: Cuñados",
        explanation:
          "Cuñado (деверь/шурин/зять), Cuñada (золовка/свояченица/невестка)",
        examples: [
          {
            spanish: "Mi cuñado es simpático",
            russian: "мой деверь симпатичный",
          },
          {
            spanish: "Mi cuñada vive en Italia",
            russian: "моя золовка живет в Италии",
          },
          {
            spanish: "Mis cuñados vienen a cenar",
            russian: "мои деверья приходят на ужин",
          },
          {
            spanish: "El hermano de mi esposa es mi cuñado",
            russian: "брат моей жены - мой шурин",
          },
          {
            spanish: "La hermana de mi marido es mi cuñada",
            russian: "сестра моего мужа - моя золовка",
          },
          {
            spanish: "Tengo tres cuñados",
            russian: "у меня три деверя/шурина",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Mi esposo tiene dos hermanos y una hermana. Sus hermanos son mis cuñados y su hermana es mi cuñada. Mi cuñada se llama Elena y es muy amable. Nos vemos frecuentemente en reuniones familiares. Mis cuñados juegan fútbol los domingos.",
        questions: [
          {
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Учимся описывать членов семьи используя прилагательные и глагол SER.",
      },
      newWords: [],
      grammar: {
        ...
        examples: [
          {
            spanish: "Mi padre es trabajador",
            russian: "мой отец трудолюбивый",
          },
          { spanish: "Mi madre es cariñosa", russian: "моя мать ласковая" },
          {
            spanish: "Mis hermanos son divertidos",
            russian: "мои братья веселые",
          },
          { spanish: "Mi abuela es sabia", russian: "моя бабушка мудрая" },
          { spanish: "Mi familia es unida", russian: "моя семья дружная" },
          {
            spanish: "Somos una familia feliz",
            russian: "мы счастливая семья",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Mi familia es maravillosa. Mi padre es inteligente y trabajador. Mi madre es amable y paciente. Mi hermano mayor es responsable. Mi hermana menor es creativa y divertida. Mis abuelos son sabios y cariñosos. Todos somos muy unidos.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-59.mp3",
    readingText:
      "Para describir a la familia usamos muchos adjetivos. Positivos: amable, cariñoso, generoso, inteligente, trabajador, divertido, alegre, paciente, sabio, responsable. Con SER: Mi padre es amable. Mi madre es cariñosa. Mis hermanos son divertidos. La familia puede ser: grande, pequeña, unida, feliz, tradicional, moderna.",
    duration: 31,
    order: 59,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Практикуем все изученные слова о семье в связном повествовании.",
      },
      newWords: [],
      grammar: {
        title: "Резюме: Vocabulario de familia",
        explanation:
          "Все слова о семье + притяжательные местоимения + описания",
        examples: [
          {
            spanish: "Me llamo Ana y tengo una familia grande",
            russian: "Меня зовут Ана и у меня большая семья",
          },
          {
            spanish: "Mis padres se llaman Juan y María",
            russian: "Моих родителей зовут Хуан и Мария",
          },
          {
            spanish: "Tengo dos hermanos y una hermana",
            russian: "У меня два брата и одна сестра",
          },
          {
            spanish: "Mis abuelos viven con nosotros",
            russian: "Мои бабушка и дедушка живут с нами",
          },
          {
            spanish: "Tengo muchos tíos y primos",
            russian: "У меня много дядь, теть и кузенов",
          },
          {
            spanish: "Mi familia es muy unida y cariñosa",
            russian: "Моя семья очень дружная и любящая",
          },
        ],
      },
      listening: {
