...
export const a1Lessons: Lesson[] = [
  // ==================== ГЛАГОЛ SER (15 УРОКОВ) ====================
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          'Глагол SER - один из двух глаголов "быть" в испанском языке. Он используется для постоянных характеристик, профессии, национальности и происхождения.',
      },
      newWords: [],
      grammar: {
        title: "Спряжение глагола SER",
        explanation:
          "SER спрягается неправильно. Важно запомнить все формы наизусть.",
        examples: [
      ...
      listening: {
        ...
        transcript:
          "Yo soy María. Tú eres Juan. Él es Carlos. Nosotros somos estudiantes. Vosotros sois amigos. Ellos son profesores.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-1.mp3",
    readingText:
      "El verbo SER es fundamental en español. Yo soy profesor. Tú eres estudiante. Nosotros somos amigos. SER se usa para características permanentes, profesiones y origen. Es muy importante practicar todas las formas del verbo SER cada día.",
    duration: 35,
    order: 1,
    isFree: true,
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "В испанском языке профессии имеют разные формы для мужского и женского рода. Для описания профессии используется глагол SER.",
      },
      newWords: [],
      grammar: {
        title: "Профессии и их формы",
        explanation:
          "Многие профессии образуют женский род заменой -o на -a или добавлением -a.",
        examples: [
          {
            spanish: "Soy profesor / profesora",
            russian: "Я преподаватель (м/ж)",
          },
          ...
          { spanish: "Soy abogado / abogada", russian: "Я адвокат (м/ж)" },
          {
            ...
            russian: "Я студент/студентка (одна форма)",
          },
          {
            spanish: "¿A qué te dedicas?",
            russian: "Чем ты занимаешься? (о профессии)",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Hola, me llamo Ana y soy profesora de español. Mi hermano es médico. Mi madre es abogada y mi padre es ingeniero. ¿A qué te dedicas tú?",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-2.mp3",
    readingText:
      "En España hay muchas profesiones interesantes. Los médicos trabajan en hospitales. Los profesores enseñan en escuelas. Los ingenieros construyen edificios. Los abogados defienden a las personas. Cada profesión es importante para la sociedad. ¿Qué profesión te gusta más?",
    duration: 40,
    order: 2,
    isFree: true,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    description:
      "Использование SER для указания национальности и происхождения",
    content: {
      introduction: {
        ...
        overview:
          "Для указания национальности используется конструкция SER + национальность, а для страны происхождения - SER DE + страна.",
      },
      newWords: [],
      grammar: {
        title: "Национальности и страны",
        explanation:
          "Национальности - это прилагательные, которые согласуются по роду и числу.",
        examples: [
      ...
      listening: {
        ...
        transcript:
          "Hola, soy Pedro y soy mexicano. Soy de México, de la ciudad de Guadalajara. Mi amiga es española, es de Barcelona. Tenemos un compañero que es ruso, es de Moscú. ¿De dónde eres tú?",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-3.mp3",
    readingText:
      "El mundo es muy grande y diverso. Hay personas de todos los países. Los españoles son de España. Los mexicanos son de México. Los rusos son de Rusia. Cada nacionalidad tiene su propia cultura e historia. Es interesante conocer personas de diferentes países y aprender sobre sus tradiciones.",
    duration: 40,
    order: 3,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  // Продолжу добавлять больше уроков...
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Для описания постоянных качеств человека используется SER + прилагательное.",
      },
      newWords: [],
      grammar: {
        title: "Прилагательные характера",
        explanation:
          "Прилагательные согласуются по роду и числу с существительным.",
        examples: [
          {
            spanish: "Soy simpático / simpática",
            russian: "Я симпатичный / симпатичная",
          },
          { spanish: "Soy inteligente", russian: "Я умный/умная (одна форма)" },
          { spanish: "Eres amable", russian: "Ты добрый/добрая" },
          {
            spanish: "Es trabajador / trabajadora",
            russian: "Он/Она трудолюбивый/трудолюбивая",
          },
      ...
      listening: {
        ...
        transcript:
          "Mi mejor amiga se llama Laura. Es una persona muy inteligente y trabajadora. También es muy simpática y generosa. Su hermano es diferente: es tímido pero muy creativo. Ambos son personas honestas y responsables.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-4.mp3",
    readingText:
      "Las personas son diferentes. Algunas son extrovertidas y otras introvertidas. Hay personas optimistas que siempre ven el lado positivo. También hay personas pesimistas que se preocupan mucho. Lo importante es ser auténtico y honesto. Cada personalidad es única y especial. ¿Cómo eres tú?",
    duration: 45,
    order: 4,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  // ==================== ГЛАГОЛ ESTAR (10 УРОКОВ) ====================
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          'ESTAR - второй глагол "быть" в испанском. Используется для местоположения и временных состояний, в отличие от SER.',
      },
      newWords: [],
      grammar: {
        title: "Спряжение глагола ESTAR",
        explanation:
          "ESTAR также спрягается неправильно. Обратите внимание на ударения.",
        examples: [
          ...
          {
            spanish: "Nosotros/Nosotras estamos",
            russian: "Мы есть (находимся)",
          },
          {
            spanish: "Vosotros/Vosotras estáis",
            russian: "Вы есть (находитесь)",
          },
      ...
      listening: {
        ...
        transcript:
          "Yo estoy en casa. Tú estás en el trabajo. María está en la escuela. Nosotros estamos en el parque. Vosotros estáis en el cine. Ellos están en el restaurante.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-5.mp3",
    readingText:
      "El verbo ESTAR es muy importante para expresar ubicación. Cuando quieres decir dónde está algo o alguien, usas ESTAR. También se usa para estados temporales: estoy cansado, estás feliz, está ocupado. Es diferente de SER porque ESTAR habla de cosas que pueden cambiar.",
    duration: 40,
    order: 5,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    description:
      "Использование ESTAR для указания где находятся предметы и люди",
    content: {
      introduction: {
        ...
        overview:
          "ESTAR + предлог места позволяет точно описать расположение объектов в пространстве.",
      },
      newWords: [],
      grammar: {
        title: "Предлоги места",
        explanation:
          "Основные предлоги: en (в), a (к/в направлении), de (из/от), sobre (на), bajo (под), entre (между), delante de (перед), detrás de (за), cerca de (около), lejos de (далеко от).",
        examples: [
          ...
          { spanish: "Estoy en casa", russian: "Я дома" },
          {
            ...
            russian: "Кот под стулом",
          },
          {
            spanish: "La escuela está cerca del parque",
            russian: "Школа рядом с парком",
          },
          {
            spanish: "Estamos entre Madrid y Barcelona",
            russian: "Мы между Мадридом и Барселоной",
          },
      ...
      listening: {
        ...
        transcript:
          "Mi apartamento está en el centro de la ciudad. La cocina está a la izquierda. El dormitorio está al lado del baño. La sala está entre la cocina y el dormitorio. El balcón está detrás de la sala. ¿Dónde está tu apartamento?",
        questions: [
          {
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "ESTAR используется для временных состояний: эмоций, настроения, самочувствия, которые могут меняться.",
      },
      newWords: [],
      grammar: {
        title: "Прилагательные с ESTAR",
        explanation:
          "С ESTAR используются прилагательные, описывающие временное состояние: cansado (уставший), feliz (счастливый), triste (грустный), enfermo (больной), ocupado (занятой).",
        examples: [
      ...
      listening: {
        ...
        transcript:
          "Hoy estoy muy feliz porque es mi cumpleaños. Mi hermana está un poco triste porque tiene que trabajar. Mi padre está cansado después del trabajo. Mi madre está ocupada preparando la cena. Todos estamos juntos esta noche para celebrar.",
        questions: [
          {
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "SER - для постоянного, ESTAR - для временного. Это основное правило, но есть нюансы.",
      },
      newWords: [],
      grammar: {
        title: "SER vs ESTAR",
        explanation:
          "SER: профессия, национальность, характер, время, владелец. ESTAR: местоположение, временное состояние, результат действия.",
        examples: [
      ...
      listening: {
        ...
        transcript:
          "Pedro es profesor. Es una persona muy paciente. Hoy está cansado porque tiene mucho trabajo. Está en la escuela desde las ocho de la mañana. La escuela es grande y está en el centro de la ciudad. Pedro es feliz con su trabajo, pero hoy está un poco estresado.",
        questions: [
          {
      ...
      phrases: [
        {
          spanish:
            "La sopa es caliente (su temperatura normal) / La sopa está caliente (ahora)",
          russian: "Суп горячий (по своей природе) / Суп сейчас горячий",
          context: "Изменение значения",
        },
        {
          spanish:
            "Soy aburrido (скучный человек) / Estoy aburrido (мне скучно)",
  ...
  // ==================== АРТИКЛИ (6 УРОКОВ) ====================
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "В испанском все существительные имеют род: мужской (el) или женский (la). Артикль указывает на конкретный предмет.",
      },
      newWords: [],
      grammar: {
        title: "El (мужской) и La (женский)",
        explanation:
          "El используется с существительными мужского рода, la - женского. Обычно слова на -o мужского рода, на -a женского рода, но есть исключения.",
        examples: [
      ...
      listening: {
        ...
        transcript:
          "El libro está en la mesa. La casa es grande. El coche es rojo. La ventana está abierta. El profesor enseña. La estudiante aprende. El día es bonito. La noche es tranquila.",
        questions: [
          {
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Los - множественное число от el, las - множественное число от la. К существительному добавляется -s или -es.",
      },
      newWords: [],
      grammar: {
        title: "Множественное число",
        explanation:
          "Если слово кончается на гласную - добавляем -s (libro→libros). На согласную - добавляем -es (ciudad→ciudades).",
        examples: [
          ...
          { spanish: "la mesa → las mesas", russian: "стол → столы" },
          {
            ...
            russian: "преподаватель → преподаватели",
          },
          { spanish: "la ciudad → las ciudades", russian: "город → города" },
          {
            spanish: "el estudiante → los estudiantes",
            russian: "студент → студенты",
          },
      ...
      listening: {
        ...
        transcript:
          "Los libros están en la biblioteca. Las mesas son nuevas. Los profesores son excelentes. Las ciudades españolas son bonitas. Los estudiantes estudian mucho. Las lecciones son interesantes.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-10.mp3",
    readingText:
      "El plural en español es bastante regular. La mayoría de las palabras que terminan en vocal añaden -s: casa→casas, libro→libros. Las palabras que terminan en consonante añaden -es: profesor→profesores, ciudad→ciudades. Hay algunas excepciones: las palabras que terminan en -z cambian a -ces: lápiz→lápices, paz→paces. Los artículos también cambian: el→los, la→las.",
    duration: 35,
    order: 10,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Un (м.р.) и una (ж.р.) используются когда говорим о чем-то неопределенном, впервые упоминаемом.",
      },
      newWords: [],
      grammar: {
        title: "Un (мужской) и Una (женский)",
        explanation:
          'Неопределенный артикль = "какой-то, один". El libro = "та самая книга", un libro = "какая-то книга".',
        examples: [
          ...
          {
            spanish: "Necesito una silla",
            russian: "Мне нужен стул (какой-нибудь)",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Tengo un coche. Es un coche rojo. Vivo en una casa. Es una casa grande. Tengo un hermano y una hermana. Mi hermano es un estudiante. Mi hermana es una profesora. Busco un trabajo nuevo.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-11.mp3",
    readingText:
      'Cuando hablas de algo por primera vez, usas el artículo indefinido: "Tengo un problema" (no especifico cuál). Cuando ya mencionaste algo, usas el artículo definido: "El problema es difícil" (ya sabemos de qué problema hablo). Esta diferencia es importante para la comunicación clara en español.',
    duration: 35,
    order: 11,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          'Unos (м.р.) и unas (ж.р.) = "несколько, какие-то, примерно". Менее конкретно чем los/las.',
      },
      newWords: [],
      grammar: {
        title: "Unos (мужской мн.ч.) и Unas (женский мн.ч.)",
        explanation:
          'Unos/unas = "несколько, какие-то". Также может означать приблизительное количество.',
        examples: [
          { spanish: "unos libros", russian: "несколько книг, какие-то книги" },
          { spanish: "unas mesas", russian: "несколько столов" },
          {
            spanish: "Tengo unos amigos en España",
            russian: "У меня есть несколько друзей в Испании",
          },
          {
            spanish: "Hay unas personas esperando",
            russian: "Несколько человек ждут",
          },
          {
            spanish: "Necesito unos días",
            russian: "Мне нужно несколько дней",
          },
          {
            spanish: "Cuesta unos veinte euros",
            russian: "Стоит примерно 20 евро",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "En mi ciudad hay unos parques muy bonitos. También hay unas tiendas interesantes. Tengo unos libros en español. Leo unas páginas cada día. Mis amigos son unos estudiantes muy dedicados. Estudiamos juntos unas tres horas al día.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-12.mp3",
    readingText:
      'El plural del artículo indefinido tiene dos usos principales. Primero, significa "algunos, varios": tengo unos amigos (varios amigos). Segundo, indica cantidad aproximada: cuesta unos diez euros (aproximadamente diez euros). Es muy útil en conversaciones cotidianas cuando no quieres ser muy específico con las cantidades.',
    duration: 35,
    order: 12,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  // ==================== ЧИСЛА (8 УРОКОВ) ====================
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Числа - основа для многих ситуаций: покупки, время, возраст, телефоны.",
      },
      newWords: [],
      grammar: {
        title: "Los números 0-10",
        explanation:
          "Эти числа нужно выучить наизусть, они используются постоянно.",
        examples: [
      ...
      listening: {
        ...
        transcript:
          "Vamos a contar: cero, uno, dos, tres, cuatro, cinco, seis, siete, ocho, nueve, diez. Tengo dos hermanos. Mi abuela tiene ochenta años pero parece de sesenta. El número de mi casa es el cinco. Mi número de teléfono termina en tres-dos-uno.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-13.mp3",
    readingText:
      'Los números son esenciales en la vida diaria. Los usas para decir la hora, el precio, tu edad, tu dirección. En español, el número "uno" cambia a "un" antes de sustantivos masculinos (un libro) y "una" antes de femeninos (una casa). Los demás números no cambian.',
    duration: 30,
    order: 13,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      ...
      grammar: {
        ...
        explanation:
          "От 11 до 15 - особые формы. От 16 до 19 - состоят из diez y... но пишутся слитно.",
        examples: [
      ...
      listening: {
        ...
        transcript:
          "Mi hermana tiene quince años. Mi hermano tiene dieciocho años. Yo tengo veinte años. En mi clase hay dieciséis estudiantes. El autobús número doce pasa cada quince minutos. La tienda cierra a las veinte horas.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-14.mp3",
    readingText:
      "Los números del 11 al 15 son irregulares y debes memorizarlos. Del 16 al 19, hay un patrón: dieciséis (diez y seis), diecisiete (diez y siete), etc. Antiguamente se escribían separados, pero ahora se escriben juntos. Nota el acento en dieciséis. El número 20 (veinte) vuelve a ser irregular.",
    duration: 30,
    order: 14,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Числа от 20 до 29 особенные, остальные десятки следуют паттерну.",
      },
      newWords: [],
      grammar: {
        title: "Los números 20-50",
        explanation:
          "20-29 пишутся слитно (veinti-), остальные раздельно через y.",
        examples: [
          { spanish: "20 - veinte", russian: "двадцать" },
      ...
      listening: {
        ...
        transcript:
          "Mi padre tiene cuarenta y cinco años. Mi madre tiene cuarenta y dos años. Mi abuelo tiene setenta años. El precio es veinticinco euros. La clase dura treinta minutos. Hay cincuenta estudiantes en total.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-15.mp3",
    readingText:
      'Hay una diferencia importante en la escritura. Los números del 21 al 29 se escriben en una palabra: veintiuno, veintidós, veintitrés, etc. Pero del 31 en adelante se escriben en tres palabras: treinta y uno, cuarenta y dos, cincuenta y tres. La "y" significa "and" en inglés.',
    duration: 35,
    order: 15,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Завершаем изучение базовых чисел. Теперь можем считать до 100!",
      },
      newWords: [],
      grammar: {
        title: "Los números 50-100",
        explanation:
          "Десятки следуют паттерну, 100 = cien (отдельно) или ciento (в составных числах).",
        examples: [
          { spanish: "50 - cincuenta", russian: "пятьдесят" },
      ...
      listening: {
        ...
        transcript:
          "Mi abuela tiene ochenta y cinco años. El libro cuesta sesenta euros. La casa tiene cien años. Hay noventa personas en la sala. El viaje dura setenta minutos. Mi peso es setenta y cinco kilos.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-16.mp3",
    readingText:
      'Con estos números ya puedes expresar precios, edades, cantidades básicas. Nota que "cien" se usa solo (tengo cien euros), pero "ciento" se usa en números compuestos (ciento uno, ciento dos). Esta es una regla importante. Del 200 en adelante hay doscientos, trescientos, etc., que aprenderás más tarde.',
    duration: 35,
    order: 16,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  // ==================== TIEMPO Y FECHAS (6 УРОКОВ) ====================
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Дни недели - essential vocabulary для планирования и разговора о расписании.",
      },
      newWords: [],
      grammar: {
        title: "Los días de la semana",
        explanation:
          "В испанском дни недели мужского рода и пишутся с маленькой буквы (кроме начала предложения).",
        examples: [
          ...
          {
            spanish: "el lunes (в понедельник, по понедельникам)",
            russian: "в понедельник",
          },
          {
            spanish: "los lunes (по понедельникам)",
            russian: "по понедельникам",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Los lunes tengo clase de español. Los martes y jueves voy al gimnasio. El miércoles es mi día favorito porque no trabajo. Los viernes salgo con amigos. El sábado y el domingo descanso. ¿Qué haces tú los fines de semana?",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-17.mp3",
    readingText:
      'En español, la semana normalmente empieza el lunes, no el domingo como en algunos países. Los días de la semana se escriben con minúscula. Cuando dices "el lunes" puede significar "este lunes" o "los lunes en general". El contexto aclara el significado. "Los lunes" siempre significa "todos los lunes, cada lunes".',
    duration: 30,
    order: 17,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Месяцы нужны для дат рождения, праздников, планирования поездок.",
      },
      newWords: [],
      grammar: {
        title: "Los meses del año",
        explanation:
          "Месяцы мужского рода, пишутся с маленькой буквы. Используются с предлогом en.",
        examples: [
      ...
      listening: {
        ...
        transcript:
          "Mi cumpleaños es en marzo. El cumpleaños de mi hermana es en julio. En enero hace mucho frío. En agosto vamos de vacaciones. La Navidad es en diciembre. Mi mes favorito es mayo porque hace buen tiempo.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-18.mp3",
    readingText:
      'Para decir fechas en español, usas el artículo "el" más el número, más "de", más el mes: el 25 de diciembre. Para el primero del mes, puedes decir "el uno" o "el primero": el primero de enero. Los meses, como los días, se escriben con minúscula en español, a diferencia del inglés.',
    duration: 35,
    order: 18,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  // ==================== ГЛАГОЛ TENER (8 УРОКОВ) ====================
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          'TENER - один из важнейших глаголов. Означает "иметь" и используется в множестве выражений.',
      },
      newWords: [],
      grammar: {
        title: "Спряжение TENER",
        explanation:
          "TENER - неправильный глагол. Корень меняется: ten- → tien- (кроме nosotros/vosotros).",
        examples: [
      ...
      listening: {
        ...
        transcript:
          "Yo tengo un coche. Tú tienes una bicicleta. Él tiene un apartamento grande. Nosotros tenemos muchos libros. Vosotros tenéis tiempo libre. Ellos tienen tres perros.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-19.mp3",
    readingText:
      "El verbo TENER es fundamental en español. Lo usamos para posesión (tengo un perro), edad (tengo 25 años), sensaciones (tengo hambre), obligación (tengo que estudiar). Es un verbo irregular con cambio vocálico: e→ie. Memoriza todas las formas porque las usarás constantemente.",
    duration: 40,
    order: 19,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "В испанском возраст выражается через TENER, не через SER (в отличие от русского).",
      },
      newWords: [],
      grammar: {
        title: "Tener + años",
        explanation:
          "Для возраста: TENER + число + años. Вопрос: ¿Cuántos años tienes?",
        examples: [
          ...
          {
            spanish: "¿Cuántos años tiene tu hermano?",
            russian: "Сколько лет твоему брату?",
          },
          {
            spanish: "Mis abuelos tienen más de 70 años",
            russian: "Моим бабушке и дедушке больше 70",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Hola, me llamo Ana y tengo 28 años. Mi esposo tiene 30 años. Tenemos un hijo que tiene 5 años. Mi madre tiene 55 años y mi padre tiene 58 años. Mis abuelos tienen 80 y 82 años. ¿Cuántos años tienes tú?",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-20.mp3",
    readingText:
      'Es importante notar que en español decimos "tener años", no "ser años". Esto es diferente al inglés ("to be years old") y al ruso. También usamos TENER para la edad de animales y objetos: "Este edificio tiene 100 años", "Mi gato tiene 5 años". Nunca olvides añadir la palabra "años" después del número.',
    duration: 35,
    order: 20,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Многие состояния, которые в русском выражаются иначе, в испанском используют TENER.",
      },
      newWords: [],
      grammar: {
        title: "Expresiones comunes",
        explanation:
          'В испанском говорят "иметь голод", "иметь холод", не "быть голодным", "быть холодно".',
        examples: [
      ...
      listening: {
        ...
        transcript:
          "Hace mucho calor hoy. Tengo mucha sed. Vamos a tomar algo frío. Mi amiga tiene hambre, quiere comer. Por la noche siempre tengo sueño temprano. En invierno tengo frío porque no me gusta el clima frío.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-21.mp3",
    readingText:
      'Las expresiones con TENER son muy comunes en la vida diaria. Otras expresiones útiles: "tener cuidado" (быть осторожным), "tener ganas de" (хотеть что-то сделать), "tener que" (должен). Para intensificar, usa "mucho/mucha": tengo mucha hambre (очень голоден). Estas expresiones son esenciales para la comunicación natural.',
    duration: 45,
    order: 21,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      ...
      grammar: {
        ...
        explanation:
          "После TENER QUE всегда идет глагол в неопределенной форме (инфинитив).",
        examples: [
          ...
          {
            spanish: "¿Tienes que salir ahora?",
            russian: "Ты должен выйти сейчас?",
          },
          {
            spanish: "No tengo que cocinar hoy",
            russian: "Мне не нужно готовить сегодня",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Hoy tengo mucho trabajo. Tengo que terminar un proyecto importante. Mi compañero tiene que hacer una presentación. Tenemos que enviar todo antes de las cinco. ¿Tú también tienes que trabajar hasta tarde?",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-22.mp3",
    readingText:
      'Tener que expresa obligación personal. Es diferente de "hay que" que expresa obligación general o impersonal. Compara: "Tengo que estudiar" (yo personalmente debo estudiar) vs "Hay que estudiar para aprender" (en general, es necesario estudiar). Tener que se conjuga según la persona, hay que nunca cambia.',
    duration: 40,
    order: 22,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  // ==================== PRESENTE -AR ГЛАГОЛЫ (10 УРОКОВ) ====================
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Глаголы на -AR - самая большая группа. Их спряжение очень регулярное.",
      },
      newWords: [],
      grammar: {
      ...
      listening: {
        ...
        transcript:
          "Yo hablo español todos los días. Mi amiga habla tres idiomas. Nosotros hablamos por teléfono cada semana. Ellos hablan muy rápido. ¿Tú hablas inglés?",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-23.mp3",
    readingText:
      "Los verbos en -AR son los más comunes en español. Algunos verbos importantes: hablar (говорить), trabajar (работать), estudiar (учиться), bailar (танцевать), cantar (петь), caminar (ходить), cocinar (готовить), comprar (покупать), escuchar (слушать), mirar (смотреть). Memoriza las terminaciones: -o, -as, -a, -amos, -áis, -an.",
    duration: 45,
    order: 23,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Расширяем словарный запас глаголами повседневного использования.",
      },
      newWords: [],
      grammar: {
        title: "Verbos útiles",
        explanation:
          "Все эти глаголы спрягаются одинаково. Учите их с примерами.",
        examples: [
          {
            spanish: "comprar (покупать) - Compro pan",
            russian: "Покупаю хлеб",
          },
          {
            spanish: "cocinar (готовить) - Cocino bien",
            russian: "Готовлю хорошо",
          },
          {
            spanish: "limpiar (убирать) - Limpio la casa",
            russian: "Убираю дом",
          },
          {
            spanish: "preparar (готовить) - Preparo café",
            russian: "Готовлю кофе",
          },
          {
            spanish: "desayunar (завтракать) - Desayuno a las 8",
            russian: "Завтракаю в 8",
          },
          {
            spanish: "cenar (ужинать) - Cenamos juntos",
            russian: "Ужинаем вместе",
          },
          {
            spanish: "nadar (плавать) - Nado en verano",
            russian: "Плаваю летом",
          },
          {
            spanish: "viajar (путешествовать) - Viajo mucho",
            russian: "Много путешествую",
          },
        ],
      },
      listening: {
        ...
        transcript:
          "Por la mañana desayuno café y tostadas. Después camino al trabajo. Trabajo ocho horas. Al mediodía como en un restaurante. Por la tarde escucho música. Por la noche ceno con mi familia. Los fines de semana viajo o nado en la piscina.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-24.mp3",
    readingText:
      "Práctica estos verbos en contexto. Otros verbos útiles: llamar (звонить), llegar (приходить/приезжать), llevar (нести/носить), buscar (искать), encontrar (находить - irregular), preguntar (спрашивать), contestar (отвечать), explicar (объяснять), ayudar (помогать). Úsalos cada día para memorizarlos mejor.",
    duration: 45,
    order: 24,
    isFree: false,
    createdAt: new Date().toISOString(),
  ...
  // ==================== PRESENTE -ER ГЛАГОЛЫ (6 УРОКОВ) ====================
  {
    ...
    content: {
      introduction: {
        ...
        overview:
          "Глаголы на -ER - вторая группа. Окончания похожи на -AR, но с E.",
      },
      newWords: [],
      grammar: {
      ...
      listening: {
        ...
        transcript:
          "Como tres veces al día. Desayuno, como y ceno. Mi familia come junta los domingos. Comemos comida española. ¿Qué comes tú normalmente? Yo bebo mucha agua. Leo libros todas las noches.",
        questions: [
          {
    ...
    audioUrl: "/audio/a1-25.mp3",
    readingText:
      "Los verbos en -ER son menos numerosos que los -AR, pero muy importantes. Verbos comunes: comer (есть), beber (пить), leer (читать), aprender (учиться), comprender (понимать), creer (верить), vender (продавать), correr (бегать). Las terminaciones son: -o, -es, -e, -emos, -éis, -en. Nota que solo cambia la vocal temática: A→E.",
    duration: 40,
    order: 25,
    isFree: false,
    createdAt: new Date().toISOString(),
      ...
      lessons.push({
        ...
        content: {
          ...
          grammar: {
            ...
            examples: [
              {
                spanish: `Ejemplo ${i + 1} de ${topic.title}`,
                russian: `Пример ${i + 1}`,
              },
